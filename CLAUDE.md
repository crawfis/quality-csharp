...
Write clean, simple, professional C# code:
...
- Keep methods short — each does one thing
...
- xUnit is always OK since we use TDD.
...
- The solution file is QualityProject.sln
- Test project is in tests/QualityProject.Tests
